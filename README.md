...
# Информация о форке: 
модификация с возможностью использования бота разными пользователями со своими собственными балансами и профилями. 

форк в разработке. работает на данный момент нестабильно

известные ошибки 
- некорректное отображение и сохранение баланса после пополнения 
---
